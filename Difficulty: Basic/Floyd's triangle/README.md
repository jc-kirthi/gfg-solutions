<h2><a href="https://www.geeksforgeeks.org/problems/floyds-triangle1222/0">Floyd's triangle</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a number <strong>n</strong>. The task is to print Floyd's triangle with n lines.</span></p>
